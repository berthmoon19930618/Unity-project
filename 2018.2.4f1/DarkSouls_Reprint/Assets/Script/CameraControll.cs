...
public class CameraControll : MonoBehaviour {
    ...
    [SerializeField]
    private GameObject camera;//主攝影機
    ...
    void Awake ()
    {
        ...
        camera = Camera.main.gameObject;//取得主要在作用的攝影機
	...
	void Update ()
    {
        ...
        tempEulerx -= pi.JUp * veticallSpeed * Time.deltaTime;//因此使用每次偵測鏡頭重直控制信號(pi.JUp)(有,無)有就遞減veticallSpeed的方法
        ...
        //製造攝影機追趕效果方法二
        camera.transform.position = Vector3.SmoothDamp(camera.transform.position, transform.position, ref velocityCameraDamp,cameraDampValue);
